...
List<Tutors> tutorsFromJson(String str) => List<Tutors>.from(json.decode(str).map((x) => Tutors.fromJson(x)));

String tutorsToJson(List<Tutors> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ProfileLanguageList {
    ...
    factory ProfileLanguageList.fromJson(Map<String, dynamic> json) => _$ProfileLanguageListFromJson(json);
...
class TeacherReviewList {
    ...
    factory TeacherReviewList.fromJson(Map<String, dynamic> json) => _$TeacherReviewListFromJson(json);
