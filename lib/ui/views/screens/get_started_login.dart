...
class GetStartedLogin extends StatefulWidget {
  static const String id = "get_started_login";
  @override
  _GetStartedLoginState createState() => _GetStartedLoginState();
}

class _GetStartedLoginState extends State<GetStartedLogin> {
      ...
      child: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage("assets/img/App_Background_Launch_Screen1.jpg"),
              fit: BoxFit.cover),
        ),
        child: Scaffold(
