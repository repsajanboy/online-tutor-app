...
class StripeSubscriptionNotLogin extends StatefulWidget {
  static const String id = "stripe_subscription_notLogin";
  final Products products;
  const StripeSubscriptionNotLogin({
    Key key,
    this.products,
  }) : super(key: key);
  @override
  _StripeSubscriptionNotLoginState createState() =>
      _StripeSubscriptionNotLoginState();
}

class _StripeSubscriptionNotLoginState
    extends State<StripeSubscriptionNotLogin> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //     errorText:
                      //         isEmailValid ? "This field is required" : null,
                            ...
                            : FlatButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (isLoading) {
                                    ...
                                    //var pass = 'justlearn123';
                                    //var emailName = email.text.split('@');
                                    //var gname = emailName[0];
                                    // print(numberCred);
                                    // print(expMonth);
                                    // print(expYear);
                                    // final userExist =
                                    //     await StripeService.checkIfUserExist(
                                    //         email.text);
                                    try {
                                      var response =
